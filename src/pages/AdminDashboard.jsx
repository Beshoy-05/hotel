...
// 2. Configure a "Toast" for non-blocking notifications
...
export default function AdminDashboard() {
  ...
  // Action Loading State (for disabling buttons)
  ...
  return (
    <>
      ...
      <div className="min-vh-100" style={{ backgroundColor: "#f4f6f9", paddingBottom: "50px" }}>
        ...
        <div className="shadow-sm py-4 px-5 mb-5 d-flex justify-content-between align-items-center" style={styles.gradientHeader}>
          ...
          <div className="d-flex gap-3">
            <button onClick={() => { reloadUsers(); reloadBookings(); reloadRooms(); Toast.fire({icon: 'info', title: 'Data Refreshed'}); }} className="btn btn-light text-primary fw-bold shadow-sm d-flex align-items-center gap-2">
                    ...
                    <div className="table-responsive">
                      <table className="table table-hover align-middle">
                        ...
                        <tbody>
                          {bookings.map(b => (
                            <tr key={b.id}>
                              <td><small className="fw-bold text-muted">#{String(b.id).substring(0,8)}</small><br/><span className="small">Room {b.roomId}</span></td>
                              <td><small>{formatDate(b.startDate)} <br/> {formatDate(b.endDate)}</small></td>
                              <td>
                  ...
                  <form onSubmit={handleCreateRoom}>
                    ...
                    <div className="row g-2 mb-3">
                      ...
                      <div className="col-5">
                        ...
                        <input type="number" className="form-control bg-light border-0 py-2" value={price} onChange={e => setPrice(e.target.value)} placeholder="$" />
                      </div>
                    </div>
      ...
      {/* Edit Modal (custom simple modal) */}
      {isEditing && (
